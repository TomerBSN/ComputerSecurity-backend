...
from communication_ltd.useful_functions import crate_ver_key
...
class ChangePassForForgotPassSerializer(serializers.ModelSerializer):
    ...
    def change_pass_one_f(self, username):
        """
